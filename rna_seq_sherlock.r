...
buildindex(basename="fullchr",reference="/scratch/PI/dpetrov/grace/fullchrmerged.fa")
...
fc <- featureCounts(bam.files, annot.inbuilt=NULL, annot.ext="/scratch/PI/dpetrov/grace/Saccharomyces_cerevisiae.R64-1-1.84.gtf", isGTFAnnotationFile = TRUE)
