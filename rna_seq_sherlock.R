...
fastq.files <- list.files(path = "./scratch/PI/dpetrov/grace", pattern = ".fastq.gz$", full.names = TRUE)
fastq.files
...
buildindex(basename="fullchr",reference="./scratch/PI/dpetrov/grace/Saccharomyces_cerevisiae.R64-1-1.cdna.all.fa.gz")
